...
earth = sphere(pos=( d*M/(m+M),0,0), radius=0.1, color=color.white, )
sun   = sphere(pos=(-d*m/(m+M),0,0), radius=1, color=color.red, )
earth.velocity = vector(0,k*math.sqrt(m/(k+1)/d),0)
